...
_Цель работы_: проверить основные ограничения в базе данных магазина. Для достижения этой цели необходимо решить задачи создание таблиц с ограничениями, проверка соблюдения ограничений 
_Язык_: SQL
_Среда_: PostgreSQL
...
_ERD диаграмма базы данных_.
![ERD](images/ERD.png)

## Проверка ограничений.
_Ограничения целостности_:
